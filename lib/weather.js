...
exports.weatherNow = function() {
  ...
  https.get(link, (response) => {
    ...
    response.on("end", () => {
        ...
        let htmlResult1 = HTMLParser.parse(htmlResult).querySelector(".now-weather > span:nth-child(1)");
        statusWeather = HTMLParser.parse(htmlResult).querySelector(".now-desc");
